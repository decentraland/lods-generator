...
namespace DCL_PiXYZ.SceneRepositioner.JsonParsing
{
    ...
    {
        public abstract PXZModel InstantiateMesh(PiXYZAPI pxz, string entityID,uint parent, uint material,Dictionary<string, string> contentTable, SceneConversionDebugInfo debugInfo, int lodLevel);
    }
